...
@section('content')
    <div class="card">
        <div class="card-body">
            <h5> Data Skala Usaha Anda : {{ $data->skalaUsaha->nama_skala_usaha }}</h5>
            <ul class="nav nav-tabs mt-5" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active text-dark text-uppercase fw-bold" id="perizinan-tab" data-bs-toggle="tab"
                        data-bs-target="#perizinan-tab-pane" type="button" role="tab"
            ...
            {{-- <form action="{{ url('pendaftaran') }}" method="post">
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="kbli-tab-pane" role="tabpanel" aria-labelledby="kbli-tab" tabindex="0">
