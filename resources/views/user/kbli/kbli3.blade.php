            ...
            <div class="card-body">
                ...
                <ul>
                    <div>
                        ...
                        <ul class="m-0 p-0">
                            <li class="m-0">
                                <a href="{{ url('kbli2/' . $kbli->kbli1->id) }}">
                                    <div class="badge font-bold text-white me-3">{{ $kbli->kbli1->kode_kbli }}</div>
                                    {{ $kbli->kbli1->nama_kbli }}
                                </a>
                            </li>
                        </ul>
                        <p class="text-uppercase fw-bold mt-3">Turunan</p>
                    </div>
                    @foreach ($kbli->kbliIII as $kb)
                        <li><a href="{{ url('kbli4/' . $kb->id) }}">
