            ...
            <div class="card-body">
                ...
                <ul>
                    <div>
                        ...
                        <ul class="m-0 p-0">
                            <li class="m-0">
                                <a href="{{ url('kbli2/' . $kbli->kbli3->kbli2->kbli1->id) }}">
                                    <div class="badge font-bold text-white me-3">
                                        {{ $kbli->kbli3->kbli2->kbli1->kode_kbli }}</div>
                                    {{ $kbli->kbli3->kbli2->kbli1->nama_kbli }}
                                </a>
                            </li>
                            <li class="m-0 mt-2">
                                <a href="{{ url('kbli3/' . $kbli->kbli3->kbli2->id) }}">
                                    <div class="badge font-bold text-white me-3">{{ $kbli->kbli3->kbli2->kode_kbli }}</div>
                                    {{ $kbli->kbli3->kbli2->nama_kbli }}
                                </a>
                            </li>
                            <li class="m-0 mt-2">
                                <a href="{{ url('kbli4/' . $kbli->kbli3->id) }}">
                                    <div class="badge font-bold text-white me-3">{{ $kbli->kbli3->kode_kbli }}</div>
                                    {{ $kbli->kbli3->nama_kbli }}
                                </a>
                            </li>
                        </ul>
                        <p class="text-uppercase fw-bold mt-3">Turunan</p>
                    </div>
                    @foreach ($kbli->kbliV as $kb)
                        <li><a href="#">
                                <div class="badge font-bold text-white me-3 px-5">{{ $kb->kode_kbli }}</div>
                                {{ $kb->nama_kbli }}
                            </a>
                        </li>
                    @endforeach
