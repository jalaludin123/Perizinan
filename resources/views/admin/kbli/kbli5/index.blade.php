...
@push('scripts')
    ...
    <script>
        $(document).ready(function($) {
                ...
                function store() {
                    $('#formAction').on('submit', function(e) {
                        ...
                        $.ajax({
                            ...
                            contentType: false,
                            success: function(res) {
                                window.LaravelDataTables["kbli5-table"].ajax
                                    .reload()
                                modal.hide()
            ...
            $('#kbli5-table').on('click', '.action', function() {
                let data = $(this).data()
                let id = data.id
