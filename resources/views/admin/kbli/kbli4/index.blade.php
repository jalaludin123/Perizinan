...
@push('scripts')
    ...
    <script>
        $(document).ready(function($) {
                ...
                function store() {
                    $('#formAction').on('submit', function(e) {
                        ...
                        $.ajax({
                            ...
                            contentType: false,
                            success: function(res) {
                                window.LaravelDataTables["kbli4-table"].ajax
                                    .reload()
                                modal.hide()
            ...
            $('#kbli4-table').on('click', '.action', function() {
                let data = $(this).data()
                let id = data.id
