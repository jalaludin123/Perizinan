...
class Kbli1DataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\Kbli1 $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Kbli1 $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('kode_kbli')->title('Kode'),
